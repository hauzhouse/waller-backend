...
function verify_data_on_server($purchase_code,$api_key,$package_name){
    $get_base_url = getBaseUrl();
    // $message = array($data);
    $data_array =  array('method_name' => 'android_app','envato_purchase_code' => $purchase_code,'api_key' => $api_key,'buyer_admin_url' => $get_base_url,'package_name' => $package_name);
